...
function App() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-6 flex flex-col h-screen">
      ...
      {weather && (
        <div className="flex-1 flex flex-col justify-center items-center">
          <div className="flex items-center space-x-6 animate-pulse">
            <img src={sunLogo} className="w-48 h-48 object-contain drop-shadow-lg" alt="Weather Icon" />
            <p className="text-7xl font-bold text-zinc-100">{weather.current.temp_c}°C</p>
          </div>
        </div>
      )}

      <div className="flex flex-row w-full mt-auto">
        <Card className="flex-1 p-4 bg-zinc-800 text-zinc-100 text-center mr-4">
          <CardContent>
              ...
              <TableBody>
                {weather?.forecast?.forecastday.map((day) => (
                  <TableRow key={day.date}>
                    ...
                    <TableCell>
                      <img src={sunLogo} className="w-10 h-10 mx-auto" alt="Weather Icon" />
                    </TableCell>
