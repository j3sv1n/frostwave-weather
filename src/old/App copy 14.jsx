      ...
      <div className="flex justify-between items-center">
        ...
        <Popover>
          ...
          <PopoverContent
            ...
            style={{
              width: inputRef.current ? `${inputRef.current.offsetWidth}px` : "300px", // Dynamically match Input width
            }}
          >
      ...
      {weather && (
        <div className="flex-1 flex flex-col justify-center items-center">
          <div className="flex items-center space-x-6">
            ...
            <p className="text-8xl font-bold text-zinc-100">
              {Math.round(weather.current.temp_c < 0.5 ? Math.floor(weather.current.temp_c) : Math.ceil(weather.current.temp_c))}°C
            </p>
          </div>
        </div>
      )}
